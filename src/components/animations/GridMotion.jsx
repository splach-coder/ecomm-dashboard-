...
const GridMotion = ({ items = [], gradientColor = 'black' }) => {
  ...
  const totalItems = 28;
  const combinedItems = items.length > 0 ? items.slice(0, totalItems) : localImages;
  ...
  return (
    <div ref={gridRef} className="h-full w-full overflow-hidden">
      ...
      >
        {/* Noise overlay */}
        <div
          className="absolute inset-0 pointer-events-none z-[4] bg-[url('../../assets/images/noise.jpg')] bg-[length:250px]"
        ></div>
